        ...
        <main class="tm-main">
          <div id="drink" class="tm-page-content">
            ...
            <div id="cold" class="tm-tab-content">
              <div class="tm-list">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/iced-cappuccino.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/iced-espresso.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/iced-latte.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
            ...
            <div id="hot" class="tm-tab-content">
              <div class="tm-list">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/hot-americano.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/hot-cappuccino.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/hot-espresso.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/hot-latte.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
            ...
            <div id="juice" class="tm-tab-content">
              <div class="tm-list">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/smoothie-2.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/smoothie-3.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                ...
                <div class="tm-list-item">
                  <img src="{{asset('front-assets/img/smoothie-4.png')}}" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
          ...
          <div id="about" class="tm-page-content">
            ...
            <div class="tm-black-bg tm-mb-20 tm-about-box-2">
              <div class="tm-list-item tm-list-item-2">
                ...
                <img src="{{asset('front-assets/img/about-2.png')}}" alt="Image" class="tm-list-item-img tm-list-item-img-big tm-img-right">
              </div>
          ...
          <div id="special" class="tm-page-content">
            <div class="tm-special-items">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('front-assets/img/special-02.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('front-assets/img/special-03.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('front-assets/img/special-04.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('front-assets/img/special-05.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="{{asset('front-assets/img/special-06.jpg')}}" alt="Image">
                <div class="tm-special-item-description">
